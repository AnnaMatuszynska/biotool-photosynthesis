...
def steady_state_photosynthesis(Ci = 300, 
                                Kc = 259,
                                Vcmax = 80,
                                gamma_star = None, Sco = 114,
                                O = 210, 
                                Ko = 179,
                                J = None,
                                I = 1000, alpha = 0.8, f = 0.15, theta = 0.7, Jmax = 135.5,
                                Tp = 300,
                                Rd = 1, 
                                gm = 1, rm = None,
                                TC = 25, R_gas = 8.31
    ...
    if [rm, gm] == [None, None] or [gamma_star, Sco] == [None, None] or [J, Jmax, I, alpha, f, theta] == [None, None, None, None, None, None]:
    ...
    if J is None and Jmax is not None and I is not None and alpha is not None and f is not None and theta is not None:
